...
contract Marketplace is IMarketplace, AccessControlEnumerable, IERC1155Receiver, IERC721Receiver, ReentrancyGuard {
    ...
    constructor(
        ...
        // set m.p treasury address
        marketplaceTreasury = payable(_msgSender());
    }
    ...
    function payout(
        ...
        transferCurrency(_currencyToUse, _payer, marketplaceTreasury, marketCut);
    ...
    /// @dev Sets the marketplace treasury address for receiving m.p payouts
    /// and royalties
    function setMarketplaceTreasury(address payable _newMarketplaceTreasury) external onlyModuleAdmin {
        marketplaceTreasury = _newMarketplaceTreasury;
    }
